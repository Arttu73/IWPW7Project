...
var PlayGame = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(PlayGame, [{
    ...
    value: function preload() {
      ...
      this.load.spritesheet("player", "Assets/Legacy-Fantasy - High Forest 2.3/Character/Idle.gif", {
        frameWidth: 32,
        frameHeight: 48
      });
    ...
    value: function create() {
      ...
      for (var i = 0; i < 20; i++) {
        this.groundGroup.create(Phaser.Math.Between(0, game.config.width), Phaser.Math.Between(0, game.config.height), "tree");
      }
    }
  }]);
  return PlayGame;
